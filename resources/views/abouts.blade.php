...
@section('content')
            <main id="main">
                    ...
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-12 center z-index1">
                                <h1 class="title">{{ __('messages.about_us') }}</h1>
                    ...
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="image-about-h4-wrap relative">
                                    <div class="image-about-item relative about-wrap-left">
                                        ...
                                        <span class="quote">{{ __('messages.cta_desc') }}</span>
                            ...
                            <div class="col-md-6 inner-content-about">
                                <div class="mb-30">
                                    <span class="sub-title-heading text-main font-yes fs-28-46">{{ __('messages.our_services') }}</span>
                                    <h2 class="title-heading mb-18">{{ __('messages.cta_title') }}</h2>
                                    <p class="des">{{ __('messages.footer_about') }}</p>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="icon-box-style6">
                                            ...
                                            <div class="content">
                                                <h6 class="title-icon"><a href="#">{{ __('messages.nav_web_dev') }}</a></h6>
                                                <p class="des-icon">{{ __('messages.footer_about') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="icon-box-style6">
                                            ...
                                            <div class="content">
                                                <h6 class="title-icon"><a href="#">{{ __('messages.nav_digital_marketing') }}</a></h6>
                                                <p class="des-icon">{{ __('messages.footer_about') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex-three btn-wrap-about ">
                                    ...
                                    <div class="profile flex-three">
                                        ...
                                        <div class="content">
                                            ...
                                            <span class="text-main">{{ __('messages.nav_strategy') }}</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-30 center">
                                    <span class="sub-title-heading text-main font-yes fs-28-46">{{ __('messages.our_services') }}</span>
                                    <h2 class="title-heading">{{ __('messages.cta_title') }}</h2>
                                </div>
                            </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tour-listing box-sd">
                                                ...
                                                <div class="tour-listing-content">
                                                    <span class="map"><i class="icon-Vector4"></i>Cotonou, Bénin</span>
                                                    <h3 class="title-tour-list"><a href="#">{{ __('messages.nav_web_dev') }}</a>
                                                    </h3>
                                                    <div class="review">
                                                        <i class="icon-Star"></i>
                                                        <i class="icon-Star"></i>
                ...
                <section class="widget-service-h5 relative pd-main">
                    <div class="tf-container">
                        <div class="row al-i-end mb-40">
                            <div class="col-md-7">
                                <div class="">
                                    <span class="sub-title-heading text-main fs-28-46 font-yes">{{ __('messages.our_services') }}</span>
                                    <h2 class="title-heading">{{ __('messages.cta_title') }}</h2>
                                </div>
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3">
                                <div class="tf-icon-box icon-box-style1 relative">
                                    ...
                                    <div class="content">
                                        <h4 class="title-icon"><a href="#">{{ __('messages.nav_web_dev') }}</a></h4>
                                        <p class="des-icon">{{ __('messages.cta_desc') }}</p>
                                        <a href="#" class="icons-link">{{ __('messages.book_now') }} <i class="icon-Path-77287-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="tf-icon-box icon-box-style1 relative">
                                    ...
                                    <div class="content">
                                        <h4 class="title-icon"><a href="#">{{ __('messages.nav_digital_marketing') }}</a></h4>
                                        <p class="des-icon">{{ __('messages.cta_desc') }}</p>
                                        <a href="#" class="icons-link">{{ __('messages.book_now') }} <i class="icon-Path-77287-1"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="tf-icon-box icon-box-style1 relative">
                                    ...
                                    <div class="content">
                                        <h4 class="title-icon"><a href="#">{{ __('messages.nav_strategy') }}</a></h4>
                                        <p class="des-icon">{{ __('messages.cta_desc') }}</p>
                                        <a href="#" class="icons-link">{{ __('messages.book_now') }} <i class="icon-Path-77287-1"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="tf-icon-box icon-box-style1 relative">
                                    ...
                                    <div class="content">
                                        <h4 class="title-icon"><a href="#">{{ __('messages.nav_ecommerce') }}</a></h4>
                                        <p class="des-icon">{{ __('messages.cta_desc') }}</p>
                                        <a href="#" class="icons-link">{{ __('messages.book_now') }} <i class="icon-Path-77287-1"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3">
                                <div class="tf-counter center tf-countto">
                                    ...
                                    <div class="number-counter number" data-to="5489" data-speed="2000"
                                        data-waypoint-active="yes">5489</div>
                                    <span class="line"></span>
                                    <p class="title-counter text-white">{{ __('messages.cta_desc') }}</p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="tf-counter center tf-countto">
                                    ...
                                    <span class="line"></span>
                                    <p class="title-counter text-white">{{ __('messages.our_services') }}</p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="tf-counter center tf-countto">
                                    ...
                                    <span class="line"></span>
                                    <p class="title-counter text-white">{{ __('messages.nav_portfolio') }}</p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="tf-counter center tf-countto">
                                    ...
                                    <div class="number-counter number" data-to="5489" data-speed="2000"
                                        data-waypoint-active="yes">5489</div>
                                    <span class="line"></span>
                                    <p class="title-counter text-white">{{ __('messages.cta_title') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Widget Ig post -->
                <section class="instagram-post pd-main relative">
                    <div class="tf-container">
                        <div class="row relative z-index3">
                            <div class="col-lg-12">
                                <div class="center mb-40">
                                    <span class="sub-title-heading text-second fs-28-46 font-yes">{{ __('messages.gallery') }}</span>
                                    <h2 class="title-heading">{{ __('messages.gallery') }}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row relative z-index3">
                    ...
                    <div class="footer-main">
                        ...
                        <div class="footer-gallery">
                            ...
                            <div class="gallery-img">
                                <a href="assets/images/gallery/gl1.jpg" data-fancybox="gallery"><img src="assets/images/gallery/gl1.jpg" alt="image gallery"></a>
                                <a href="assets/images/gallery/gl2.jpg" data-fancybox="gallery"><img src="assets/images/gallery/gl2.jpg" alt="image gallery"></a>
                                <a href="assets/images/gallery/gl3.jpg" data-fancybox="gallery"><img src="assets/images/gallery/gl3.jpg" alt="image gallery"></a>
                                <a href="assets/images/gallery/gl4.jpg" data-fancybox="gallery"><img src="assets/images/gallery/gl4.jpg" alt="image gallery"></a>
                                <a href="assets/images/gallery/gl5.jpg" data-fancybox="gallery"><img src="assets/images/gallery/gl5.jpg" alt="image gallery"></a>
                                <a href="assets/images/gallery/gl6.jpg" data-fancybox="gallery"><img src="assets/images/gallery/gl6.jpg" alt="image gallery"></a>
                            </div>
                        </div>
