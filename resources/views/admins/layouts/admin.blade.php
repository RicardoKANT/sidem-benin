...
<!-- Mirrored from bestwpware.com/html/tf/duralux-demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Mar 2026 19:16:59 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset("dashboards/assets/images/favicon.ico") }}" />
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset("dashboards/assets/css/bootstrap.min.css") }}" />
    <!--! END: Bootstrap CSS-->
    <!--! BEGIN: Vendors CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset("dashboards/assets/vendors/css/vendors.min.css") }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset("dashboards/assets/vendors/css/daterangepicker.min.css") }}" />
    <!--! END: Vendors CSS-->
    <!--! BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset("dashboards/assets/css/theme.min.css") }}" />
    <!--! END: Custom CSS-->
...
<body>
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ route('dashboard') }}" class="b-brand">
                    ...
                    <img src="{{ asset("images/logo.png") }}" alt="" height="100px" width="80px" class="logo logo-lg" />
            ...
            <div class="navbar-content">
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('dashboard') }}">Accueil</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('contact-info.edit') }}">Infos de Contact</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('slider-info.index') }}">Slide Principal</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('holidays.index') }}">Fêtes Internationales</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="javascript:void(0);">Général</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="javascript:void(0);">Sécurité</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Contenu</span>
                            <span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('blogs.index') }}">Articles du Blog</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="javascript:void(0);">Pages</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="javascript:void(0);">Liste des utilisateurs</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="javascript:void(0);">Rôles & Permissions</a></li>
                        </ul>
                    </li>
                </ul>
                ...
                <div style="margin-top: 30px; padding: 20px; border-top: 1px solid #eee;">
                    <div style="font-size: 12px; color: #666; display: flex; flex-direction: column; gap: 10px;">
                        ...
                        <div style="display: flex; align-items: center; gap: 8px;">
                            ...
                            <span><a href="mailto:{{ \App\Models\ContactInfo::first()->email ?? 'support@sidem-benin.com' }}" style="color: #666; text-decoration: none;">{{ \App\Models\ContactInfo::first()->email ?? 'support@sidem-benin.com' }}</a></span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <i class="feather-phone"></i>
                            <span><a href="tel:{{ str_replace(' ', '', \App\Models\ContactInfo::first()->phone ?? '+229 01 XX XX XX XX') }}" style="color: #666; text-decoration: none;">{{ \App\Models\ContactInfo::first()->phone ?? '+229 01 XX XX XX XX' }}</a></span>
                        </div>
                        <hr style="margin: 10px 0; border-top: 1px solid #ddd;">
                        <a href="{{ route('contact-info.edit') }}" style="color: #0d6efd; font-size: 11px; text-decoration: none; font-weight: 500; display: inline-block;">
                            ⚙️ Gérer les infos
                        </a>
                    </div>
                </div>
                                    ...
                                    <div class="tab-content nxl-mega-menu-tabs-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                            <div class="mb-4 rounded-3 border">
                                                <img src="{{ asset("dashboards/assets/images/banner/mockup.png") }}" alt="" class="img-fluid rounded-3" />
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-applications" role="tabpanel">
                                            <div class="row g-4">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="{{ asset("dashboards/assets/images/general/full-avatar.png") }}" alt="" class="img-fluid full-user-avtar" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-lg-flex align-items-center justify-content-between">
                                                ...
                                                <div class="mt-2 mt-lg-0">
                                                    <a href="https://bestwpware.com/cdn-cgi/l/email-protection#89fefbe8f9eae6edecfbfac9eee4e8e0e5a7eae6e4" class="fs-13 fw-bold text-primary">Contact Us &rarr;</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                            <div class="row g-lg-4 nxl-mega-menu-integrations">
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/app-store.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/spotify.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/figma.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/shopify.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/paypal.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/gmail.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/dropbox.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/google-drive.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/github.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/gitlab.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/facebook.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/pinterest.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/instagram.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/twitter.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="{{ asset("dashboards/assets/images/brand/youtube.png") }}" alt="" class="img-fluid" />
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="{{ asset("dashboards/assets/images/banner/1.jpg") }}" alt="" class="img-fluid" />
                                                    </div>
                                                    <div class="mt-4">
                                                        <a href="https://bestwpware.com/cdn-cgi/l/email-protection#5027223120333f3435222310373d31393c7e333f3d" class="fs-13 fw-bold">View all resources on Duralux &rarr;</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div id="carouselResourcesCaptions" class="carousel slide" data-bs-ride="carousel">
                                                        ...
                                                        <div class="carousel-inner rounded-3">
                                                            <div class="carousel-item active">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset("dashboards/assets/images/banner/6.jpg") }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset("dashboards/assets/images/banner/5.jpg") }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset("dashboards/assets/images/banner/4.jpg") }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset("dashboards/assets/images/banner/3.jpg") }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset("dashboards/assets/images/banner/2.jpg") }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="{{ asset("dashboards/assets/images/banner/1.jpg") }}" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                        ...
                                                        <div class="col-xxl-10">
                                                            <div class="row g-4">
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/1.jpg") }}" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{ asset("dashboards/assets/images/avatar/1.png") }}" alt="" class="img-fluid" />
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/2.jpg") }}" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{ asset("dashboards/assets/images/avatar/2.png") }}" alt="" class="img-fluid" />
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/3.jpg") }}" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{ asset("dashboards/assets/images/avatar/3.png") }}" alt="" class="img-fluid" />
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/4.jpg") }}" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="{{ asset("dashboards/assets/images/avatar/4.png") }}" alt="" class="img-fluid" />
                                                                                </div>
                                                ...
                                                <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                    <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                        ...
                                                        <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                            ...
                                                            <div class="mt-4">
                                                                <a href="https://bestwpware.com/cdn-cgi/l/email-protection#1166637061727e7574636251767c70787d3f727e7c" class="fs-13 fw-bold">View all features on Duralux &rarr;</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-xxl-10">
                                                            <div class="row g-4">
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/1.jpg") }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/2.jpg") }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/3.jpg") }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/4.jpg") }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/5.jpg") }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="{{ asset("dashboards/assets/images/banner/6.jpg") }}" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="search-items-wrapper">
                                ...
                                <div class="users-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="https://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="26474a435e0842434a4a47664953524a49494d0845494b">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="https://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e4839681818aca87919081a48b9190888b8b8fca878b89">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="avatar-text avatar-md">
                                            <i class="feather-chevron-right"></i>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="https://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8ce1ede0ede2e5e9a2ede2fae9f5cce3f9f8e0e3e3e7a2efe3e1">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="avatar-text avatar-md">
                                            <i class="feather-chevron-right"></i>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="fs-11 text-muted mb-0"><a href="https://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d4bfb1baa0bcfabca1bab194bba1a0b8bbbbbffab7bbb9">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="avatar-text avatar-md">
                                            <i class="feather-chevron-right"></i>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="{{ asset("dashboards/assets/images/avatar/5.png") }}" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                                <a href="javascript:void(0);" class="font-body fw-bold d-block mb-1">Archie Cantones</a>
                                                <p class="fs-11 text-muted mb-0"><a href="https://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6f0e1d0c07060a410c00010a1c2f001a1b03000004410c0002">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                        <a href="javascript:void(0);" class="avatar-text avatar-md">
                                            <i class="feather-chevron-right"></i>
                                ...
                                <div class="file-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset("dashboards/assets/images/file-icons/css.png") }}" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset("dashboards/assets/images/file-icons/zip.png") }}" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset("dashboards/assets/images/file-icons/pdf.png") }}" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                    ...
                    <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                        <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            <img src="{{ asset("dashboards/assets/vendors/img/flags/4x3/us.svg") }}" alt="" class="img-fluid wd-20" />
                        </a>
                                ...
                                <div class="row px-4 pt-3">
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/sa.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Arabic</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/bd.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Bengali</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/ch.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Chinese</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/nl.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Dutch</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select active">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/us.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>English</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/fr.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>French</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/de.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>German</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/in.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Hindi</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/ru.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Russian</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/es.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Spanish</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/tr.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Turkish</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="{{ asset("dashboards/assets/vendors/img/flags/1x1/pk.svg") }}" alt="" class="img-fluid" /></div>
                                            <span>Urdo</span>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            <div class="notifications-item">
                                <img src="{{ asset("dashboards/assets/images/avatar/2.png") }}" alt="" class="rounded me-3 border" />
                            ...
                            <div class="notifications-item">
                                <img src="{{ asset("dashboards/assets/images/avatar/3.png") }}" alt="" class="rounded me-3 border" />
                                <div class="notifications-desc">
                            ...
                            <div class="notifications-item">
                                <img src="{{ asset("dashboards/assets/images/avatar/4.png") }}" alt="" class="rounded me-3 border" />
                                <div class="notifications-desc">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="{{ asset("dashboards/assets/images/avatar/1.png") }}" alt="user-image" class="img-fluid user-avtar me-0" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset("dashboards/assets/images/avatar/1.png") }}" alt="user-image" class="img-fluid user-avtar" />
                                    <div>
                                        <h6 class="text-dark mb-0">Alexandra Della <span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                        <span class="fs-12 fw-medium text-muted"><a href="https://bestwpware.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9bfaf7fee3b5fffef7f7fadbf4eeeff7f4f4f0b5f8f4f6">[email&#160;protected]</a></span>
                                    </div>
                                </div>
                            </div>
                            <div class="dropdown">
    ...
    <!--! ================================================================ !-->
    <!--! BEGIN: Vendors JS !-->
    <script src="{{ asset("dashboards/assets/vendors/js/vendors.min.js") }}"></script>
    <!-- vendors.min.js {always must need to be top} -->
    <script src="{{ asset("dashboards/assets/vendors/js/daterangepicker.min.js") }}"></script>
    <script src="{{ asset("dashboards/assets/vendors/js/apexcharts.min.js") }}"></script>
    <script src="{{ asset("dashboards/assets/vendors/js/circle-progress.min.js") }}"></script>
    <!--! END: Vendors JS !-->
    <!--! BEGIN: Apps Init  !-->
    <script src="{{ asset("dashboards/assets/js/common-init.min.js") }}"></script>
    <script src="{{ asset("dashboards/assets/js/dashboard-init.min.js") }}"></script>
    <!--! END: Apps Init !-->
    <!--! BEGIN: Theme Customizer  !-->
    <script src="{{ asset("dashboards/assets/js/theme-customizer-init.min.js") }}"></script>
    <!--! END: Theme Customizer !-->
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon='{"version":"2024.11.0","token":"e97d358126754c0fad9102db62fedc44","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9de693262c8e8d3b',t:'MTc3Mzg2MTQxNw=='};var a=document.createElement('script');a.src='../../../cdn-cgi/challenge-platform/h/b/scripts/jsd/833f25fde7cb/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>


<!-- Mirrored from bestwpware.com/html/tf/duralux-demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Mar 2026 19:19:10 GMT -->
</html>
