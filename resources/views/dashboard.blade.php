                        ...
                        <div class="card stretch stretch-full overflow-hidden">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="{{ asset("dashboard/assets/images/brand/shopify.png" alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="{{ asset("dashboard/assets/images/brand/app-store.png" alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg p-2 rounded">
                                            <img class="img-fluid" src="{{ asset("dashboard/assets/images/brand/figma.png" alt="" />
                                        </div>
                                        <div>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset("dashboard/assets/images/avatar/2.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                                            <span class="d-block">Archie Cantones</span>
                                                            <span class="fs-12 d-block fw-normal text-muted"><span class="__cf_email__" data-cfemail="573625343e3279233839322417303a363e3b7934383a">[email&#160;protected]</span></span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset("dashboard/assets/images/avatar/3.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                                            <span class="d-block">Holmes Cherryman</span>
                                                            <span class="fs-12 d-block fw-normal text-muted"><span class="__cf_email__" data-cfemail="f89f9794958bd69b909996b89f95999194d69b9795">[email&#160;protected]</span></span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset("dashboard/assets/images/avatar/4.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                                            <span class="d-block">Malanie Hanvey</span>
                                                            <span class="fs-12 d-block fw-normal text-muted"><span class="__cf_email__" data-cfemail="2e424f40474b0040584b57406e49434f4742004d4143">[email&#160;protected]</span></span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset("dashboard/assets/images/avatar/5.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                                            <span class="d-block">Kenneth Hune</span>
                                                            <span class="fs-12 d-block fw-normal text-muted"><span class="__cf_email__" data-cfemail="d1bfbfb4a5b9ffa4bfb491b6bcb0b8bdffb2bebc">[email&#160;protected]</span></span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset("dashboard/assets/images/avatar/6.png" alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                                            <span class="d-block">Valentine Maton</span>
                                                            <span class="fs-12 d-block fw-normal text-muted"><span class="__cf_email__" data-cfemail="d5b4b9b0bbbcbbb0fbb4a1babb95b2b8b4bcb9fbb6bab8">[email&#160;protected]</span></span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td>
                                ...
                                <div class="p-3 border border-dashed rounded-3 mb-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="img-group lh-0 ms-3 justify-content-start d-none d-sm-flex">
                                            ...
                                            <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                <img src="{{ asset("dashboard/assets/images/avatar/5.png" class="img-fluid" alt="image" />
                                            </a>
                                            <a href="javascript:void(0)" class="avatar-image avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Marianne Audrey">
                                                <img src="{{ asset("dashboard/assets/images/avatar/6.png" class="img-fluid" alt="image" />
                                            </a>
                                ...
                                <div class="mb-3">
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset("dashboard/assets/images/brand/app-store.png" alt="laravel-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset("dashboard/assets/images/brand/figma.png" alt="figma-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset("dashboard/assets/images/brand/facebook.png" alt="vue-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="mb-4 pb-1 d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset("dashboard/assets/images/brand/github.png" alt="react-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset("dashboard/assets/images/brand/paypal.png" alt="sketch-logo" class="me-3" width="35" />
                                            <div>
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action">
                                <div class="hstack justify-content-between border border-dashed rounded-3 p-3 mb-3">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image">
                                            <img src="{{ asset("dashboard/assets/images/avatar/1.png" alt="" class="img-fluid" />
                                        </div>
                                        <div>
