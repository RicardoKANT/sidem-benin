...
@section('title', __('messages.realisation_detail_title'))
            ...
            <main id="main">
                ...
                <section>
                    <div class="tf-container full">
                        <div class="row">
                            <div class="col-md-12">
<img src="{{ asset('assets/images/page/breakcrumb2.jpg" alt="image">
                            </div>
                        </div>
                    </div>
                </section>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="inner-heading-wrap flex-two">
                                                    ...
                                                    <div class="inner-price">
                                                        ...
                                                        <p class="price-sale text-main">$130.00 <span
                                                                class="price">$16000</span></p>
                                                    </div>
...
<img src="{{ asset('assets/images/destination/1.jpg" alt="image">
                                            </div>
                                            <div class="col-6 col-sm-3">
<img src="{{ asset('assets/images/destination/2.jpg" alt="image">
                                            </div>
                                            <div class="col-6 col-sm-3">
<img src="{{ asset('assets/images/destination/3.jpg" alt="image">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-8">
...
<img src="{{ asset('assets/images/blog/re-blog1.jpg"
                                                                        alt="Image">
                                                                </a>
                                                            ...
                                                            <div class="list-recent flex-three">
                                                                <a href="blog-details.html" class="recent-image">
<img src="{{ asset('assets/images/blog/re-blog2.jpg"
                                                                        alt="Image">
                                                                </a>
                                                                <div class="recent-info">
                                                                    <div class="start">
                                                            ...
                                                            <div class="list-recent flex-three">
                                                                <a href="blog-details.html" class="recent-image">
<img src="{{ asset('assets/images/blog/re-blog3.jpg"
                                                                        alt="Image">
                                                                </a>
                                                                <div class="recent-info">
                                                                    <div class="start">
                                                    ...
                                                    <div class="client-review mb-80">
                                                        ...
                                                        <div class="client-review-list">
                                                            <div class="client-review-item flex">
                                                                <div class="avata">
<img src="{{ asset('assets/images/avata/avt-review.jpg"
                                                                        alt="image">
                                                                </div>
                                                                <div class="content">
...
<img src="{{ asset('assets/images/gallery/gallery.jpg" alt="image"
                                                            class="item1">
                                                    </div>

                                                    <div class="image-gallery2 image">
<img src="{{ asset('assets/images/gallery/gallery2.jpg" alt="image"
                                                            class="item2">
                                                    </div>

                                                    <div class="image-gallery3 image">
<img src="{{ asset('assets/images/gallery/gallery3.jpg" alt="image"
                                                            class="item1">
                                                    </div>

                                                    <div class="image-gallery4 image">
<img src="{{ asset('assets/images/gallery/gallery4.jpg" alt="image"
                                                            class="item2">
                                                    </div>

                                                    <div class="image-gallery5 image">
<img src="{{ asset('assets/images/gallery/gallery5.jpg" alt="image"
                                                            class="item1">
                                                    </div>

                                                    <div class="image-gallery6 image">
<img src="{{ asset('assets/images/gallery/gallery6.jpg" alt="image"
                                                            class="item2">
                                                    </div>
                                                </div>
