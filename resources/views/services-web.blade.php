@extends('layouts.app')
@section('title', __('messages.service_web_title'))
@section('content')
<main>
    <!-- Breadcrumb -->
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">{{ __('messages.service_web_title') }}</li>
                </ol>
            </nav>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead">{{ __('messages.service_web_desc') }}</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p class="mb-4">
                        Nous créons des applications web modernes, performantes et sécurisées adaptées à vos besoins métier. De la conception à la mise en production, nous assurons la qualité et la scalabilité de votre solution.
                    </p>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h5 class="fw-bold">Responsive Web Design</h5>
                                    <p class="text-muted mb-0">Sites web optimisés pour tous les appareils (desktop, tablet, mobile)</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="d-flex">
                                <div class="me-3"><span style="font-size: 24px;">✓</span></div>
                                <div>
                                    <h5 class="fw-bold">Performance Optimale</h5>
                                    <p class="text-muted mb-0">Pages rapides avec temps de chargement < 3 secondes</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="d-flex">
                                <div class="me-3"><span style="font-size: 24px;">✓</span></div>
                                <div>
                                    <h5 class="fw-bold">SEO Optimisé</h5>
                                    <p class="text-muted mb-0">Structure optimisée pour les moteurs de recherche</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Certificats SSL, HTTPS, protection contre les injections SQL</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="d-flex">
                                <div class="me-3"><span style="font-size: 24px;">✓</span></div>
                                <div>
                                    <h5 class="fw-bold">Scalabilité</h5>
                                    <p class="text-muted mb-0">Architecture evoluive qui grandit avec votre business</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Maintenance, updates et support technique 24/7</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <div class="process-step">
                                ...
                                <h5 class="fw-bold">Analyse & Consultation</h5>
                                <p class="text-muted">Comprendre vos objectifs et requirements</p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="process-step">
                                ...
                                <h5 class="fw-bold">Design & Prototypage</h5>
                                <p class="text-muted">Création des wireframes et prototypes interactifs</p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="process-step">
                                ...
                                <p class="text-muted">Codage expert avec technologies modernes (Laravel, React, Vue.js)</p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="process-step">
                                ...
                                <h5 class="fw-bold">Tests & Déploiement</h5>
                                <p class="text-muted">Assurance qualité, tests complets et lancement en production</p>
                            </div>
                        </div>
                    </div>

                    <h3 class="fw-bold mt-5 mb-4">Technologies Utilisées</h3>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="tech-card p-3 border rounded">
                                <h6 class="fw-bold">Backend</h6>
                                <p class="text-muted mb-0">Laravel, Node.js, Python, PHP</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="tech-card p-3 border rounded">
                                <h6 class="fw-bold">Frontend</h6>
                                <p class="text-muted mb-0">React, Vue.js, Angular, Bootstrap</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="tech-card p-3 border rounded">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text text-muted mb-0 small">Applications mobiles natives</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text text-muted mb-0 small">Design graphique professionnel</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text text-muted mb-0 small">SEO et digital marketing</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4" style="background: #f8f9fa;">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-3"><strong>Durée:</strong><br><span class="text-muted">4-12 semaines selon complexité</span></li>
                                <li class="mb-3"><strong>Prix:</strong><br><span class="text-muted">À partir de 2,000€</span></li>
                                <li class="mb-3"><strong>Disponibilité:</strong><br><span class="badge bg-success">{{ __('messages.available') }}</span></li>
                                <li class="mb-3"><strong>Support:</strong><br><span class="text-muted">24/7 inclus 6 mois</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="accordion-item border-0 mb-2">
                                ...
                                <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                                    <div class="accordion-body">
                                        Le délai varie selon la complexité. Un site standard: 4-8 semaines. Une application complexe: 12+ semaines.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item border-0 mb-2">
                                ...
                                <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                                    <div class="accordion-body">
                                        Nous utilisons les technologies les plus modernes: Laravel/React côté web, technos mobiles natives. Flexible selon vos besoins.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item border-0">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq3">
                                        Offrez-vous le support après lancement?
                                    </button>
                                </h2>
                                <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                                    <div class="accordion-body">
                                        Oui! 6 mois de support 24/7 inclus. Maintenance, bug fixes, updates de sécurité tout compris.
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="cta-final py-5" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
        <div class="container text-center">
            ...
            <p class="lead mb-4">Lancez votre projet web avec SIDEM-BENIN</p>
            <div>
