                                ...
                                <div class="slider-home1 relative overflow-hidden swiper-slide">
                                    <div class="silider-image">
                                        ...
                                        <div class="booking-title tf-anime-rorate">
                                            <p class="booking">{{ __("messages.book_now") }}</p>
                                            <span></span>
                                        </div>
                                    </div>
                                    <div class="slider-content">
                                        <div class="tf-container">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <span class="sub-title text-main font-yes fs-28-46 fadeInDown wow">{{ $slider->subtitle ?? __('messages.our_services') }}</span>
                                                    <h1 class="title-slide text-white mb-32 fadeInDown wow">{{ $slider->title ?? __('messages.cta_title') }}
                                                        <span class="animationtext clip text-main">
                                                            <span class="cd-words-wrapper">
                                                                <span class="item-text is-visible">{{ $slider->animated_text ?? 'Camping' }}</span>
                                                                <span class="item-text is-hidden">{{ $slider->animated_text ?? 'Camping' }}</span>
                                                            </span>
                                                        </span>
                                                    </h1>
                                                    <p class="des text-white mb-45 fadeInDown wow">{{ $slider->description ?? __('messages.footer_about') }}</p>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn-main fadeInDown wow">
                                                            <p class="btn-main-text">{{ $slider->cta_button_text ?? __('messages.cta_btn') }}</p>
                                                            <p class="iconer">
                                                                <i class="icon-arrow-right"></i>
                                                            </p>
                                                        </a>
                                                        <a href="#" class="btn-w-wa fadeInDown wow">{{ $slider->secondary_button_text ?? 'Who we are' }} <i class="icon-Group-13"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="slider-home1 relative overflow-hidden swiper-slide">
                                    ...
                                    <div class="slider-content">
                                        <div class="tf-container">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <span class="sub-title text-main font-yes fs-28-46 fadeInDown wow">{{ __('messages.our_services') }}</span>
                                                    <h1 class="title-slide text-white mb-32 fadeInDown wow">{{ __('messages.cta_title') }}
                                                        <span class="animationtext clip text-main">
                                                            <span class="cd-words-wrapper">
                                                    ...
                                                    <p class="des text-white mb-45 fadeInDown wow">{{ __('messages.footer_about') }}</p>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn-main fadeInDown wow">
                                                            <p class="btn-main-text">{{ __('messages.cta_btn') }}</p>
                                                            <p class="iconer">
                                                                <i class="icon-arrow-right"></i>
                                                            </p>
                                                        </a>
                                        ...
                                        <div class="flex wd-search">
                                            ...
                                            <div class="form-group flex">
                                                ...
                                                <div class="search-bar-group">
                                                    <label>Type</label>
                                                    <div class="nice-select" tabindex="0">
                                                        <span class="current">{{ __('messages.nav_services') }}</span>
                                                        <ul class="list">
                                                            <li data-value class="option selected">{{ __('messages.nav_services') }}</li>
                                                            <li data-value="booking" class="option">{{ __('messages.nav_services') }}</li>
                                                            <li data-value="booking" class="option">{{ __('messages.nav_services') }}</li>
                                                            <li data-value="booking" class="option">{{ __('messages.nav_services') }}</li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="search-bar-group">
                                                    ...
                                                    <div class="nice-select" tabindex="0">
                                                        ...
                                                        <ul class="list">
                                                            ...
                                                            <li data-value="booking" class="option">Web & Mobile</li>
                                                            <li data-value="booking" class="option">Marketing Digital</li>
                                                            <li data-value="booking" class="option">Conseil Stratégique</li>
                                                        </ul>
                                                    </div>
                    ...
                    <div class="tf-container">
                        <div class="row pt-35">
                            <div class="col-lg-12 flex">
                                ...
                                <p class="client fadeInUp wow">{{ __('messages.cta_desc') }}</p>
                            </div>
                        </div>
                        <div class="row pt-115">
                            ...
                            <div class="col-lg-6">
                                <div class="inner-content-about">
                                    <span class="sub-title-heading text-main mb-15 fadeInUp wow">{{ __('messages.our_services') }}</span>
                                    <h2 class="title-heading mb-18 fadeInUp wow">{{ __('messages.cta_title') }} <span
                                            class="text-gray font-yes">SIDEM-BENIN</span></h2>
                                    <p class="des-heading fadeInUp wow">{{ __('messages.footer_about') }}</p>
                                    <div class="row mt-27 fadeInUp wow">
                                        <div class="col-sm-6">
                                            <div class="icon-box-style3">
                                                ...
                                                <h6 class="title mb-10"><a href="#">{{ __('messages.nav_strategy') }}</a></h6>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    <span class="sub-title-heading text-main mb-15 fadeInUp wow">{{ __('messages.our_services') }}</span>
                                    <h2 class="title-heading mb-40 fadeInUp wow">{{ __('messages.our_services') }} <span class="text-gray font-yes">SIDEM-BENIN</span></h2>
                                </div>
                                ...
                                <ul class="nav nav-tabs-activities justify-content-center" id="myTablist"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                            ...
                                            <span>{{ __('messages.nav_web_dev') }}</span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                            ...
                                            <span>{{ __('messages.nav_digital_marketing') }}</span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="ab-tab" data-bs-toggle="tab"
                                            ...
                                            <span>{{ __('messages.nav_strategy') }}</span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                        ...
                                        <div class="tabs-activities-content flex">
                                            ...
                                            <div class="activities-content relative">
                                                <span class="sub-title text-white">{{ __('messages.nav_services') }}</span>
                                                <h3 class="title-activitis text-white mb-60">{{ __('messages.cta_title') }}</h3>
                                                <div class="flex-three mb-30">
                                                    <div class="flex-three text-white icon-list-wrap">
                                                        <div class="icon">
                                                            <i class="icon-Page-1"></i>
                                                        </div>
                                                        <span class="icon-lists">{{ __('messages.our_services') }}</span>
                                                    </div>
                                                    <div class="flex-three text-white icon-list-wrap">
                                                        <div class="icon">
                                                            <i class="icon-rubber-ring-1"></i>
                                                        </div>
                                                        <span class="icon-lists">{{ __('messages.cta_btn') }}</span>
                                                    </div>
                                                </div>
                                                <div class="flex-three btn-wrap-activitis">
                                                    ...
                                                    <a href="#" class="text-white get-start">{{ __('messages.book_now') }}</a>
                                                </div>
                                                <img src="assets/images/page/mask-tap.png" alt="image"
                                                    class="mask-tab">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row align-center z-index3 relative">
                            <div class="col-lg-5">
                                <div class="content">
                                    <div class="mb-50">
                                        <span class="sub-title-heading text-main mb-15 fadeInUp wow">{{ __('messages.our_services') }}</span>
                                        <h2 class="title-heading mb-32 fadeInUp wow">{{ __('messages.our_services') }} <span class="text-gray font-yes">SIDEM-BENIN</span></h2>
                                        <p class="des-heading fadeInUp wow">{{ __('messages.footer_about') }}</p>
                                    </div>
                                    <div class="inner-content flex-three">
                                        <div class="offer fadeInUp wow">
                                            <span class="number">{{ __("messages.book_now") }}</span>

                                        </div>
                                        <p class="font-italic fadeInUp wow">{{ __('messages.cta_title') }}</p>
                    ...
                    <div class="tf-container">
                        <div class="row mb-50">
                            <div class="col-lg-9 flex-three cta-wrap">
                                ...
                                <div class="content">
                                    <h2 class="title-call text-white mb-18 fadeInUp wow">{{ __('messages.cta_title') }}</h2>
                                    <p class="des text-white fadeInUp wow">{{ __('messages.cta_desc') }}
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="callt-to-action-button text-end fadeInRight wow">
                                    <a href="#" class="get-call">{{ __('messages.cta_btn') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading mb-40">
                                    <span class="sub-title-heading text-main mb-15 fadeInUp wow">{{ __('messages.our_services') }}</span>
                                    <h2 class="title-heading fadeInUp wow">{{ __('messages.cta_title') }}</h2>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <nav class="mb-40 adventure-scroll">
                                        <div class="nav nav-justified nav-tabs-adventure" id="nav-tab" role="tablist">
                                            <li class="nav-link flex-three active" id="nav-home-tab"
                                                ...
                                                <span>{{ __('messages.nav_ecommerce') }}</span>
                                            </li>
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3">
                                                    <div class="tf-adventure flex-three mb-43">
                                                        ...
                                                        <div class="adventure-image">
                                                            ...
                                                            <h6 class="title-ad"><a
                                                                    href="tour-single.html">Switzerland</a></h6>
                    ...
                    <div class="tf-container">
                        <div class="row z-index3 relative">
                            <div class="col-lg-7 content-banner-contact">
                                <div class="mb-32">
                                    <span
                                        class="sub-title-heading text-main mb-15 font-yes fs-28-46 wow fadeInUp animated">{{ __('messages.our_services') }}</span>
                                    <h2 class="title-heading text-white wow fadeInUp animated">{{ __('messages.cta_title') }}</h2>
                                </div>
                ...
                <section class="pd-main">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    <span class="sub-title-heading text-main mb-15 wow fadeInUp animated">{{ __('messages.our_services') }}</span>
